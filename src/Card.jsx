  ...
  return (
    <section className="w-[320px] h-[548px] flex flex-col">
      ...
      <article className="bg-high_1 flex flex-col grow">
        ...
        <button className="rounded-full bg-primary text-high_1 p-2 px-6 mx-4 my-8 font-sec font-bold text-[1.15rem] flex items-center justify-center gap-4 hover:bg-sec_1 hover:text-high_2">
